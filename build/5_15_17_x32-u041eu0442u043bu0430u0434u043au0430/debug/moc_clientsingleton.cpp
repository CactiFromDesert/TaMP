...
void ClientSingleton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ClientSingleton::*)(const QString & )>(_a, &ClientSingleton::responseReceived, 0))
            return;
    }
}
...
// SIGNAL 0
void ClientSingleton::responseReceived(const QString & _t1)
{
